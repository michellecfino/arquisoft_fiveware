...
BEGIN
    IF NOT EXISTS (
        ...
        CREATE TYPE nucleo.estado_notificacion_enum AS ENUM (
            'Pendiente',
            'Enviada',
            'Fallida'
        );
...
BEGIN
    IF NOT EXISTS (
        ...
        CREATE TYPE nucleo.moneda_enum AS ENUM (
            'USD',
            'COP',
            'EUR'
        );
...
BEGIN
    IF NOT EXISTS (
        ...
        CREATE TYPE nube.proveedor_enum AS ENUM (
            'Amazon Web Services',
...
/* Tabla intermedia para relacionar proyectos con cuentas cloud, ya que un proyecto puede tener múltiples cuentas cloud y una cuenta cloud puede estar asociada a múltiples proyectos. */
